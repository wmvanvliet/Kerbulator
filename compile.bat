...
mkdir build
"%MCS%" -t:library -lib:"%KSPDIR%\%MANAGED%" -r:Assembly-CSharp,Assembly-CSharp-firstpass,UnityEngine,UnityEngine.CoreModule,UnityEngine.IMGUIModule,UnityEngine.AnimationModule -out:build\Kerbulator.dll *.cs
